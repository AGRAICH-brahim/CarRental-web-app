...
<header> 
    <nav>
      <ul>      
        ...
        <div class="buttons">
			<a href="../../index.php" class="login">Déconnexion</a>
		    </div>
    </nav>
  </header>
</br>
    ...
    <section id="reservation">
      ...
      <div class="title">
        ...
        <div class="line"></div>
			...
			<form action="./showVehicule/availableCarsController.php?action=ablecars" method="post">
				<div>
            ...
            <script>
              ...
              var dateInput1 = document.getElementById("date-debut");
              var dateInput2 = document.getElementById("date-fin");

              // Définir la date minimale comme étant la date actuelle
              dateInput1.min = currentDate;
              dateInput2.min = currentDate;
            </script>
					<label for="lieu-depart">
            <img src="../../VIEW/images/location.png" />
            <span>Agence de départ</span>
          </label>
					<select id="lieu-depart" name="lieu-depart" required>
...
<section id="features">
    ...
    <section id="cta">
    <h2>Réservez dès maintenant votre voiture</h2>
